...
export const filterStyles = {
  ...
  earlyWeaponNormal:    { text: "#00FFFF", background: "#000000", border: "#00FFFF" },
  ...
  twoLink:              { text: "#ffffff", background: "#000000", border: "#FFC800" , backgroundOpacity: 0.8},
  selectedTwoLink:      { text: "#ffe68d", background: "#000000", border: "#FFC800" },
  threeLink:            { text: "#ffffff", background: "#000000", border: "#51FF00" , backgroundOpacity: 0.8},
  selectedThreeLink:    { text: "#B9FF66", background: "#000000", border: "#B9FF66" },
  fourLink:             { text: "#ffffff", background: "#000000", border: "#00FF88" , backgroundOpacity: 0.8},
