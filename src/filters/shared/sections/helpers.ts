...
export type SocketBasesConfig = {
  maxAreaLevel?: number
  goodShieldBaseTypes?: readonly Shields[]
...
export type EarlyActsConfig = {
  ...
  momentumSocketGroups?: readonly ThreeLinkPattern[]
...
export const getShieldThreeLinkSoundPrefix = (pattern: ThreeLinkPattern) => (pattern === "RGG" ? "2g1r" : undefined)
...
export const normalizeShieldProgressionConfig = (shieldProgression?: ShieldProgressionConfig) => {
  if (!shieldProgression || shieldProgression === "none") {
    return { enabled: false, maxAreaLevel: 12 }
  }

  if (shieldProgression === "early") {
    return { enabled: true, maxAreaLevel: 12 }
  }
  ...
  if (mode === "none") {
    return { enabled: false, maxAreaLevel: shieldProgression.maxAreaLevel ?? 12 }
  }
  ...
  return {
    enabled: true,
    maxAreaLevel: shieldProgression.maxAreaLevel ?? 12,
  }
}
