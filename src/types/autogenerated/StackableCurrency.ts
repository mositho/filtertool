export type StackableCurrency =
  ...
  | "Scrying Orb"
  | "Karui Enshrouding Crystal"
  | "Imperial Enshrouding Crystal"
  | "Vaal Enshrouding Crystal"
  | "Templar Enshrouding Crystal"
  | "Maraketh Enshrouding Crystal"
  | "Merrick's Ducat"
  | "Cyaxan's Ducat"
  | "Dead Man's Sulphur"
  | "Message in a Bottle"
